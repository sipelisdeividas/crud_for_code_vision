            ...
            <div class="col-lg-5 pl-lg-5 pb-3 py-lg-5">
                <form action="/register" method="POST" id="registration-form">
                    ...
                    <div class="form-group">
                        <label for="username-register" class="text-muted mb-1"><small>Vartotojo Vardas</small></label>
                        <input name="username" value="{{old('username')}}" id="username-register" class="form-control" type="text"
                            placeholder="Sugalvokite vartotojo vardą" autocomplete="off" />
                            @error('username')
                    ...
                    <div class="form-group">
                        ...
                        <input name="email" value="{{old('email')}}" id="email-register" class="form-control" type="text"
                            placeholder="crudas@pavyzdys.com" autocomplete="off" />
                            @error('email')
                            <p class="m-0 small alert alert-danger shadow-sm">{{ $message }}</p>
                            @enderror
                    </div>
