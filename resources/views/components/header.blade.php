<header class="header-bar mb-3 border-bottom">
    ...
    <div class="container d-flex flex-column flex-md-row align-items-center p-3">
      ...
      <div class="flex-row my-3 my-md-0">
        ...
        @if (auth()->user()->is_admin)
            <a title="Produkto Talpinimas" data-toggle="tooltip" data-placement="bottom" class="btn btn-sm btn-info mr-2" href="/create-product"><i class="fa-solid fa-upload"></i> Talpinti</a>
            <a title="Visi Produktai" data-toggle="tooltip" data-placement="bottom" class="btn btn-sm btn-secondary mr-2" href="/products"><i class="fa-solid fa-truck-front"></i> Produktai</a>
        @endif
